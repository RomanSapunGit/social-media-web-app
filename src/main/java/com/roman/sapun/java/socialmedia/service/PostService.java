...
public interface PostService {
     ...
     */
    ResponsePostDTO getPostById(String identifier, HttpServletRequest request) throws PostNotFoundException, UserNotFoundException, UserStatisticsNotFoundException;
