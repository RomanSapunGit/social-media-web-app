...
public interface VoteService {
  ...
  * Add an upvote to a post identified by its identifier.
        ...
        */
        Set<ResponseUserDTO> addUpvote(String identifier, Authentication authentication) throws JsonProcessingException, UserNotFoundException, PostNotFoundException;
         ...
         */
        Set<ResponseUserDTO> removeUpvote(String identifier, Authentication authentication) throws UserNotFoundException, PostNotFoundException;
         ...
         * @throws JsonProcessingException If there is an issue processing the JSON data.
         */
        Set<ResponseUserDTO> addDownvote(String identifier, Authentication authentication) throws JsonProcessingException, UserNotFoundException, PostNotFoundException;
         ...
         */
        Set<ResponseUserDTO> removeDownvote(String identifier, Authentication authentication) throws UserNotFoundException, PostNotFoundException;
